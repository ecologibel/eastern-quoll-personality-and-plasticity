...
raw_data_filename <- "data.xlsx"

# Read in behavioural assay data
assay <- read_excel(raw_data_filename, sheet="assay") %>%
...
post <- read_excel(raw_data_filename, sheet="postrelease") %>%
...
```{r, results='hide', warning=FALSE, message=FALSE}
# Read in den data
den <- read_excel(raw_data_filename, sheet="den")
